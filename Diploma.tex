...
D3, OpenGL, izbran OGL ker je what the cool kids use these days.
\section{Projekcija teksture na 3D model}
Matematka za tem.
\chapter{Implementacija}
\section{Programska ovojnica za LWJGL}
Opis wrapperja za LWJGL.
\section{Samostojna aplikacija}
Opis implementacije samostojne aplikacije.
